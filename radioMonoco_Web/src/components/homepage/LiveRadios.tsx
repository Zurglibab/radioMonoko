            ...
            >
                {extendedRadios.map((radio, index) => (
                    <div key={index} className="relative flex-shrink-0 w-full h-full overflow-hidden">
                        ...
                        {/* Overlay subtil sur toute l'image */}
                        <div className="absolute inset-0 bg-black/20 z-10" />

                        {/* GRADIENT MODIFIÉ : Noir profond en bas, remonte progressivement */}
                        <div className="absolute inset-0 bg-gradient-to-t from-black/95 via-black/40 via-25% to-transparent z-10" />
