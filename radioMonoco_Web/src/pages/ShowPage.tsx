    ...
    useEffect(() => {
        ...
        const fetch = async () => {
            try {
                ...
                console.error(err);
                setError(t("common.errorOccurred") || "Impossible de charger les données.");
            } finally {
    ...
    return (
        <div className={`relative min-h-screen ${theme === "dark" ? "bg-app-bg text-app-text" : "bg-neutral-50 text-neutral-800"}`}>
            <main className="max-w-[1400px] mx-auto px-6 pt-24 pb-32">
                ...
                {error && (
                    <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-xl flex items-start gap-3 mb-8 animate-in fade-in slide-in-from-top-4">
