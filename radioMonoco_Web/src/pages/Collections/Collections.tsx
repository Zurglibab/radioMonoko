...
const Collections = () => {
    ...
    const handleCreateCollection = async (name:string, description:string, isPublic:boolean) => {
        try{
            ...
            console.error(err);
            setError(t("collections.errors.create"));
        }
    };
    ...
    const handleModifyCollection = async (collection: Collection) => {
        try {
            ...
            console.error(err);
            setError(t("collections.errors.modify"));
        }
    };
    ...
    const handleDeleteCollection = async (collectionId: string) => {
        try {
            ...
            console.error(err);
            setError(t("collections.errors.delete"));
        }
    };
        ...
        <div className="flex min-h-screen bg-[#0a0a0a]">
            ...
            <div className="flex-1 px-6 md:px-12 py-24 relative overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    {loading && (
                        <p className="text-neutral-500 mt-4">{t("collections.loading")}</p>
                    )}
                    {error && (
                                ...
                                >
                                    ...
                                    <div className="flex justify-between items-center mt-5">
                                        <span className="text-xs text-neutral-500">
                                            {item.is_public ? t("collections.public") : t("collections.private")}
                                        </span>
