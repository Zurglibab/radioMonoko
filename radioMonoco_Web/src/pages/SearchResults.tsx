...
import { useAppearance } from "../context/AppearanceContext"; // Import ajouté
                ...
                <div className="mb-12">
                        ...
                        <div className="grid md:grid-cols-3 gap-4 mb-12">
                            {results.users.map((u) => (
                                ...
                                >
                                    ...
                                    {u.bio && <p className="text-neutral-500 text-sm mt-4 line-clamp-2">{u.bio}</p>}
                                </div>
                            ))}
                        </div>
                    )}
                    ...
                    <div className="mt-12">
                        ...
                        {results.shows.length === 0 ? (
                            <p className="text-neutral-500">Aucune émission trouvée</p>
                        ) : (
                            <div className="grid md:grid-cols-3 gap-4">
                                {results.shows.map((show) => (
                                    ...
                                    >
                                        ...
                                        <p className="text-neutral-500 text-sm mt-2 line-clamp-3">{show.standFirst || "Aucune description disponible"}</p>
                                        <span className="text-xs text-rose-400 mt-3 inline-block font-semibold">Voir l'émission →</span>
                                    </div>
                                ))}
                            </div>
                        )}
